...
<head>
        ...
        <title>PETZEE</title>
        <link rel="icon"href="assets/img/paw.png"type="image/x-icon">
        <link rel="shotcuticon" href="assets/img/Petzee.png">
        <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
        <link rel="stylesheet" type="text/css" id = "test" href="assets/css/style.css"/>
        <script>
...
<div class="container ">
    <div class="control d-flex  justify-content-around">
        ...
        <form method="get" action="index.php" class=" ">
                        ...
                        <option value='0'>TYPES OF PETS</option>
                            <?php
